...
class activity_producto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_producto) // Establece el layout de la actividad.
        ...
        // Configuración del botón para agregar al carrito.
        ...
        botonPerfil.setOnClickListener {
            val intent = Intent(this, activity_usuario::class.java) // Redirige al perfil del usuario.
            startActivity(intent)
        }
    }
}
